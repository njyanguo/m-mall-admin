...
class Ctrl {
     ...
     */
    routes() {
        this.app.get('/api/goodsTypes', this.getAll.bind(this))
        this.app.get('/api/goodsTypes/:id', this.get.bind(this))
        this.app.post('/api/goodsTypes', this.post.bind(this))
        this.app.put('/api/goodsTypes/:id', this.put.bind(this))
        this.app.delete('/api/goodsTypes/:id', this.delete.bind(this))
        //this.app.get('/api/goodsTypes/search/all', this.search.bind(this))
    }
    ...
    /**
     * @api {get} /goodsTypes/:id 获取某个指定资源的信息
     ...
     *
     * @apiPermission none
     * @apiSampleRequest /goodsTypes/:id
     * 
     * @apiUse Header
     * @apiUse Success
     */
